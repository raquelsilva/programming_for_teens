...
The first instruction is: download the package Anaconda. You can use this <a href="https://www.anaconda.com">link</a>. After the installation, to be able to open the notebooks you need to launch the module named "Jupyter Notebook". If you only need to see the content inside of the notebooks you just need to click on the files listed at the github or you can open it using an external viewer named "nbviewer". You can find it using this <a href="https://nbviewer.jupyter.org">link</a>. To open the notebook, copy and paste the address of the page.
